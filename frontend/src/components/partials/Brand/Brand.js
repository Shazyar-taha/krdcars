...
export default function Brand(props) {
    return (
        <div className="brand" style={{ ...props.style }}>
            <svg id="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 202.09 36.84">
                <g id="krd" data-name="krd" style={{ fill: props?.krdColor ? props.krdColor : "#000" }}>
                    <path d="M9.84,9.4h7.68L14,18.92,27.28,9.4h8.56L22,20l7.68,10.6H21.12l-7.84-9.52L9.8,30.6H2.12Z" />
                    ...
                    <path d="M85,21a27.78,27.78,0,0,1-3.38,4.42,16.54,16.54,0,0,1-3.78,3,16.08,16.08,0,0,1-4.52,1.7,26.4,26.4,0,0,1-5.6.54h-10L65.48,9.4h17.4a4.24,4.24,0,0,1,3.48,1.32,5.13,5.13,0,0,1,1.08,3.36,10.83,10.83,0,0,1-.6,3.38A12.41,12.41,0,0,1,85,21ZM71.28,14.8l-3.8,10.4h1a7.31,7.31,0,0,0,2.24-.42,16.59,16.59,0,0,0,2.56-1.1,15.46,15.46,0,0,0,2.36-1.54,7.12,7.12,0,0,0,1.64-1.74,8.79,8.79,0,0,1,.52-.72,3.43,3.43,0,0,0,.52-.92c.16-.43.33-.84.5-1.24a2.88,2.88,0,0,0,.26-1.12,2.06,2.06,0,0,0-.3-1.14,1.16,1.16,0,0,0-1.06-.46Z" />
                </g>
                <g id="krd" data-name="krd" style={{ fill: props?.carsColor ? props.carsColor : "#ed1c24" }}>
                    ...
                    <path d="M131.09,30.6l-.84-4.52a5,5,0,0,1-.58.92c-.34.45-.71.93-1.12,1.44s-.82,1-1.22,1.4a3.51,3.51,0,0,1-.88.76H109.53c0-.21.08-.31.08-.28V30.2L124,11.8a3.35,3.35,0,0,1,.48-.64,9.57,9.57,0,0,1,.78-.78,10,10,0,0,1,.84-.68,1.3,1.3,0,0,1,.7-.3h6.72a1,1,0,0,1,.74.44,4.21,4.21,0,0,1,.58,1.08,13.12,13.12,0,0,1,.42,1.34l.3,1.18,2.64,17.16Zm-9-5.36h8.12l-1.4-9.4-6.72,9Z" />
